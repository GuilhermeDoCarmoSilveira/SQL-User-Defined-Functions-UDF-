...
begin
	...
	set @valorUnitario = (select valor_unitario
	from Produto_1
	where nome = @nome)
...
Begin
	...
	Select c.nome, p.nome, cl.quantidade
	from Cliente c, Produto_1 p, Cliente_Produto cl 
	where c.codigo = cl.cliente
	...
	Update @tabela
	set data_hoje = convert(varchar(10), getdate(), 103)			
	Return
End
